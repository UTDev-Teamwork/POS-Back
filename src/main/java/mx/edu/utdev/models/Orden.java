...
public class Orden {
    ...
    public Orden(int id_pedido, BigInteger num_pedido, Timestamp fecha_pedido, int id_proveedor, String status_pedido, short no_dias, Timestamp fecha_autorizado, String plan, short anio, short mes, Timestamp fecha_registro) {
